                    ...
                    }
                    {
                      vehicles?.map((vehicle, index) => {
                        ...
                        return (
                          ...
                          <tr key={index} >
                            <th className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left flex items-center notranslate">
                              <span
                                className={
                                  "ml-3 font-bold notranslate" +
