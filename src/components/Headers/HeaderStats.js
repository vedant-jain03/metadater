...
function Popup({setPopup}) {
  return (
    <>
      <div className="popup_container mx-auto px-4 h-full w-full">
            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
              <div className="rounded-t mb-0 px-6 py-6">
                <div className="text-center mb-3">
                  ...
                  <span className="bg-blueGray-500 text-blueGray active:bg-lightBlue-600 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow outline-none focus:outline-none ease-linear transition-all duration-150 absolute cross_popup" onClick={()=>setPopup(false)} >x</span>
                </div>
              </div>
